            ...
            if data["object"] == "page":
                if data["entry"][0]["messaging"]:
                    ...
                    if u_count is None:
                        ...
                        message_data = "Hey "+sender_fname_stripped+", thanks for reaching out.. Less than a year ago I was living in my car, but my life has changed since working with a millionaire mentor who showed me how to make money from home, about $1000 a day at the moment. I feel truly blessed since getting started at http://realendeavors.com/workfromhome"
                ...
                if data["entry"][0]["changes"][0]["value"]["item"]=="comment":
                    ...
                    if post_check is not None: 
                        ...
                        if u_count is None:
                            ...
                            message_data = "Hey "+sender_fname+", just saw your comment.. Less than a year ago I was living in my car, but my life has changed since working with a millionaire mentor who showed me how to make money from home, about $1000 a day at the moment. I feel truly blessed since getting started at http://realendeavors.com/workfromhome"
