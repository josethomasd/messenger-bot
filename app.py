            ...
            if data["object"] == "page":
                if data["entry"][0]["messaging"]:
                    ...
                    if u_count is None:
                        ...
                        message_data = "Hi "+sender_fname_stripped+", I was living in my car less than a year ago when a friend I used to work with at a call center sent me this link: http://realendeavors.com/my-mentor and it's changed everything for me. Now I'm making $700 a day from home and they mail me checks every week. I feel truly blessed and wanted to share with others."
                ...
                if data["entry"][0]["changes"][0]["value"]["item"]=="comment":
                    ...
                    if post_check is not None: 
                        ...
                        if u_count is None:
                            ...
                            message_data = "Hi "+sender_fname+", I was living in my car less than a year ago when a friend I used to work with at a call center sent me this link: http://realendeavors.com/my-mentor and it's changed everything for me. Now I'm making $700 a day from home and they mail me checks every week. I feel truly blessed and wanted to share with others."
